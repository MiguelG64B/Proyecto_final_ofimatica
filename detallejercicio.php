...
if (isset($_GET['id2'])) {
  $resultado = $conexion->query("select * from contenido where id_contenido=" . $_GET['id2']) or die($conexion->error);
          ...
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              ...
              <td class="align-middle text-center text-sm">
                <span class="badge badge-sm bg-gradient-success">Ejercicio</span>
              </td>
